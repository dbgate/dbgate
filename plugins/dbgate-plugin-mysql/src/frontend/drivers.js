...
const mysqlDriverBase = {
  ...
  getNativeOperationFormArgs(operation) {
    // Captured locally so that the hiddenFn closures below do not depend on how the UI invokes them.
    const nodejsBackupTool = this.nodejsBackupTool;
    if (operation == 'backup') {
      return [
        ...(this.supportsNodejsBackup
          ? [
              {
                type: 'select',
                label: __t('mysqlDriver.backupTool', { defaultMessage: 'Backup tool' }),
                name: 'backupTool',
                default: this.nodejsBackupTool,
                testId: 'BackupDatabaseTab_backupTool',
                options: [
                  { name: this.nativeBackupTool || 'mysqldump', value: this.nativeBackupTool || 'mysqldump' },
                  { name: this.nodejsBackupTool, value: this.nodejsBackupTool },
                ],
              },
            ]
          : []),
        {
          type: 'checkbox',
          label: __t('mysqlDriver.noData', { defaultMessage: 'No data (dump only structure)' }),
          name: 'noData',
          default: false,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.noStructure', { defaultMessage: 'No structure (dump only data)' }),
          name: 'noStructure',
          default: false,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.force', { defaultMessage: 'Force (ignore all errors)' }),
          name: 'force',
          default: false,
          hiddenFn: values => values.backupTool == nodejsBackupTool,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.includeEvents', { defaultMessage: 'Backup events' }),
          name: 'includeEvents',
          default: true,
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.includeRoutines', { defaultMessage: 'Backup routines' }),
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.includeTriggers', { defaultMessage: 'Backup triggers' }),
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.lockTables', { defaultMessage: 'Lock tables' }),
          name: 'lockTables',
          default: false,
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.skipLockTables', { defaultMessage: 'Skip lock tables' }),
          name: 'skipLockTables',
          default: false,
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.singleTransaction', { defaultMessage: 'Single transaction' }),
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.createDatabase', { defaultMessage: 'Create database' }),
          name: 'createDatabase',
          default: false,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.dropDatabase', { defaultMessage: 'Drop database before import' }),
          name: 'dropDatabase',
          default: false,
        ...
        {
          type: 'checkbox',
          label: __t('mysqlDriver.extendedInsert', { defaultMessage: 'Use extended inserts' }),
          name: 'extendedInsert',
          default: true,
          hiddenFn: values => values.backupTool != nodejsBackupTool,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.completeInsert', { defaultMessage: 'Include column names in inserts' }),
          name: 'completeInsert',
          default: false,
          hiddenFn: values => values.backupTool != nodejsBackupTool,
        },
        {
          type: 'checkbox',
          label: __t('mysqlDriver.hexBlob', { defaultMessage: 'Write binary values in hexadecimal' }),
          name: 'hexBlob',
          default: true,
          hiddenFn: values => values.backupTool != nodejsBackupTool,
        },
    ...
    if (operation == 'restore' && this.supportsNodejsRestore) {
      return [
        {
          type: 'select',
          label: __t('mysqlDriver.restoreTool', { defaultMessage: 'Restore tool' }),
          name: 'restoreTool',
          default: this.nodejsRestoreTool,
          testId: 'RestoreDatabaseTab_restoreTool',
          options: [
            { name: this.nativeRestoreTool || 'mysql', value: this.nativeRestoreTool || 'mysql' },
            { name: this.nodejsRestoreTool, value: this.nodejsRestoreTool },
          ],
        },
      ];
    }
...
const mysqlDriver = {
  ...
  nodejsBackupTool: 'dbgate-mysql-dumper',
  nodejsRestoreTool: 'dbgate-mysql-dumper',
  ...
  icon: { light: mySqlIconLight, dark: mySqlIconDark },
};
...
const mariaDriver = {
  ...
  nodejsBackupTool: 'dbgate-mysql-dumper',
  nodejsRestoreTool: 'dbgate-mysql-dumper',
  nativeBackupTool: 'mariadb-dump',
  nativeRestoreTool: 'mariadb',
  supportsServerSummary: true,
  supportsServerSqlChat: true,
