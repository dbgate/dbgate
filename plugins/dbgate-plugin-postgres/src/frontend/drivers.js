  ...
  getNativeOperationFormArgs(operation) {
    if (operation == 'backup') {
      return [
        ...
        {
          type: 'checkbox',
          label: __t('postgresDriver.noPrivileges', { defaultMessage: 'Prevent dumping of access privileges (grant/revoke)' }),
          name: 'noPrivileges',
          default: false,
        },
        {
          type: 'checkbox',
          label: __t('postgresDriver.noOwner', { defaultMessage: 'Do not output commands to set ownership of objects' }),
          name: 'noOwner',
          default: false,
        },
        {
